...
def main():
    ...
    parser.add_argument('-eot', '--edge_tts_output_path', type=str, default='C:/Users/zhangkaihao/so-vits-svc/raw/audio.wav', help='edge_tts语音保存路径')
    ...
    volume = args.edge_tts_volume
    #tts = edge_tts.Communicate(text = TEXT, voice = voice, rate = rate, volume=volume)
    #tts.save(args.edge_tts_output_path)
